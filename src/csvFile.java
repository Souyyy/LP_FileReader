...
public class csvFile extends FileType {
    ...
    // Affiche le contenu du fichier CSV à l'endroit (ordre des lignes normal)
    @Override
    ...
    // Affiche le contenu du fichier CSV à l'envers (ordre des lignes inversé)
    @Override
    ...
    // Affiche le contenu du fichier CSV de manière palindromique (inverser les caractères de chaque ligne)
    @Override
